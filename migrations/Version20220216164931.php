 ...
 */
final class Version20220216164931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande ADD commande_id INT NOT NULL, ADD produit_id INT NOT NULL, DROP id_commande_id, DROP id_produit_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE ligne_commande ADD id_commande_id INT NOT NULL, ADD id_produit_id INT NOT NULL, DROP commande_id, DROP produit_id');
        ...
        $this->addSql('ALTER TABLE ligne_commande ADD PRIMARY KEY (id_commande_id, id_produit_id)');
